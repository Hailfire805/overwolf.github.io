...
A Knowledge base is what we call your app's public library and documentation. Anything users want to know and educate themselves on regarding your app, they should be able to find inside your app's Knowledge base.

### Basics

* Always write Knowledge base articles using the Wordpress editor, and avoid copying & pasting from another program. If you prefer to write elsewhere, make sure that you clear all text formatting before pasting your article into the Wordpress editor - you can do this bycopying your text into windows notepad and then from there to Wordpress should work.

* Keep your article short, clear and to the point so that users can easily find what they are looking for.
...
An article type we've found useful for gamers is one focused on any technical issues they might experience with the app along with, how if possible, to fix them. Just like in the FAQ, focus on figuring out what issues your userbase consider to be most important. Good things to include are repeatedly reported issues or anything that you would like to help users be able to solve. 

A good example of this type of article is [Legendary Builds – Troubleshooting](https://support.overwolf.com/support/solutions/articles/9000180372-legendary-builds-troubleshooting).
